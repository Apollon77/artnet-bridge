...
/**
 * Execute a script in a package that conforms to artnet-bridge conventions.  This is primarily useful within an
 * artnet-bridge development environment but should also work when installed via NPM.
 *
